...
def make_cellEyalEtAl2018(
    ...
    if cell_model is None:
        ...
        # loading mechanisms
        mod_folder = myfunctions.posixpth(join(model_folder, "ActiveMechanisms"))
...
def columnPlot(num_neurons, positions, electrodeParameters):
    ...
    for cellindex in range(num_neurons):
        "L3-PCs"
        cell = make_cellEyalEtAl2018(morphology="2013_03_06_cell03_789_H41_03.ASC")
...
if __name__ == "__main__":
    ...
    np.savez("cellsPops_L3PCs.npz", cellPositions_L3=cellpositions)
